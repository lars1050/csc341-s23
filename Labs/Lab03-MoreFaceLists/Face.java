...
public class Face {
    ...
    public double compare(Face other) {
        ...
        double f = (double) width/height - (double) other.width/other.height;
        double e = eyeDelta*2.0/width - other.eyeDelta*2.0/other.width;
        double n = (double) noseLength/height - (double) other.noseLength/other.height;
        double m = (double) mouthDelta/height - (double) other.mouthDelta/other.height;

        return f*f + e*e + n*n + m*m;
    }
